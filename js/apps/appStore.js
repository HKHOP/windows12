...
const AppStore = (() => {
    ...
    const appDetails = {
        vscode: {
            ...
            features: ['Integrated terminal', 'Syntax highlighting', 'File explorer', 'Extensions marketplace', 'Git integration'],
            screenshots: [
                { bg: 'linear-gradient(135deg, #1e1e1e, #2d2d2d)', text: 'Code Editor' },
                { bg: 'linear-gradient(135deg, #007ACC, #1e90ff)', text: 'Integrated Terminal' }
            ],
            size: '95 MB', ageRating: '3+'
        },
        sampleApp: {
            name: 'Sample App',
        ...
        export: {
            ...
            features: ['Drag-and-drop import', 'File browser export', 'Multiple destination folders', 'File type detection', 'Batch operations'],
            screenshots: [
                { bg: 'linear-gradient(135deg, #0078D4, #00BCF2)', text: 'Import Files' },
                { bg: 'linear-gradient(135deg, #00BCF2, #0078D4)', text: 'Export Files' }
            ],
            size: '1 MB', ageRating: '3+'
        },
        words: {
            name: 'Words',
            developer: 'Windows 12',
            ...
            features: ['Rich text formatting', 'Table creation and editing', 'Hyperlink support', 'Print and export', 'Formatting toolbar'],
            screenshots: [
        ...
        sledgePoint: {
            ...
            features: ['Ribbon-style toolbar', 'Slide transitions (fade, slide, zoom)', 'Text, shapes, images, and tables', 'Freehand drawing tools', 'Presentation mode with slideshow', 'Export to HTML, PDF, SVG, and JSON'],
            screenshots: [
        ...
        cellESheet: {
            ...
            features: ['Formula support (SUM, AVERAGE, MIN, MAX)', 'Multi-sheet workbooks', 'Ribbon-style toolbar', 'Cell references and range selection', 'Save/load from virtual filesystem'],
            screenshots: [
