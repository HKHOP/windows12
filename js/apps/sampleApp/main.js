// Sample App — reference template for folder-based apps.
// Every app lives in js/apps/<id>/ with a manifest.json, main.js (this file),
// scripts/ (extra modules) and assets/ (static files). See APP_DEVELOPMENT_GUIDE.md.
// Rule: never call AppLoader/AppRegistry at module scope (import cycle) —
// only inside functions like launch().
