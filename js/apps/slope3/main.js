...
const Slope3 = (() => {
    const APP_ID = 'slope3';
    const GAME_URL = 'https://subwayonline.io/slope-3.embed';
    const HOME_URL = 'https://subwayonline.io/slope-3';
    const icon = `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="4" fill="#1a0f2e"/><path d="M4 18 13 9l7-3-3 7-8 5H4v-0z" fill="#2c1c55"/><circle cx="15" cy="12" r="3.2" fill="#c77dff"/><circle cx="9" cy="16" r="1.1" fill="#ffd166"/></svg>`;
    ...
    function getContent() {
        ...
        <div class="arc-root" style="position:absolute;inset:0;display:flex;flex-direction:column;min-height:0;background:#000;color:#fff;">
            ...
            <iframe class="arc-frame" title="Slope 3" tabindex="0" src="${GAME_URL}"
    ...
    function launch() {
        const win = WindowManager.createWindow(APP_ID, 'Slope 3', icon, getContent(), { width: 900, height: 620, minWidth: 480, minHeight: 360 });
