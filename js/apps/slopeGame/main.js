...
const Slope = (() => {
    const APP_ID = 'slopeGame';
    const GAME_URL = 'https://gamezipper.com/slope/?utm_source=windows12';
    const HOME_URL = 'https://gamezipper.com/slope/';
    const icon = `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="4" fill="#0e0e12"/><path d="M4 18 14 8l6-3-3 6-8 7H4v-0z" fill="#2b2b33"/><circle cx="15" cy="12" r="3.2" fill="#4ecdc4"/><path d="M4 18h5" stroke="#4ecdc4" stroke-width="1.6" stroke-linecap="round"/></svg>`;
    ...
    function getContent() {
        ...
        <div class="arc-root" style="position:absolute;inset:0;display:flex;flex-direction:column;min-height:0;background:#000;color:#fff;">
            ...
            <iframe class="arc-frame" title="Slope" tabindex="0" src="${GAME_URL}"
    ...
    function launch() {
        const win = WindowManager.createWindow(APP_ID, 'Slope', icon, getContent(), { width: 900, height: 620, minWidth: 480, minHeight: 360 });
