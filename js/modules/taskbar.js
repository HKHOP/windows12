...
const AppMetadata = (() => {
    const metadata = {
        ...
        appStore: {
            ...
            icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 3H10V10H3V3Z" fill="#0078D4"/><path d="M14 3H21V10H14V3Z" fill="#0078D4"/><path d="M3 14H10V21H3V14Z" fill="#0078D4"/><path d="M14 14H21V21H14V14Z" fill="#0078D4"/></svg>`,
            iconSmall: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 3H10V10H3V3Z" fill="#0078D4"/><path d="M14 3H21V10H14V3Z" fill="#0078D4"/><path d="M3 14H10V21H3V14Z" fill="#0078D4"/><path d="M14 14H21V21H14V14Z" fill="#0078D4"/></svg>`
        },
        terminal: {
            name: 'Terminal',
        ...
        export: {
            name: 'Ex/port',
            icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3v12m0 0l-4-4m4 4l4-4" stroke="#0078D4" stroke-width="2" stroke-linecap="round"/><path d="M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2" stroke="#0078D4" stroke-width="2" stroke-linecap="round"/></svg>`,
            iconSmall: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 3v12m0 0l-4-4m4 4l4-4" stroke="#0078D4" stroke-width="2" stroke-linecap="round"/><path d="M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2" stroke="#0078D4" stroke-width="2" stroke-linecap="round"/></svg>`
        }
    };
