const AppIcons = (() => {
    const icons = {
        ...
        copilotButBetter: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" fill="#10a37f"/><path d="M12 5l1.7 4.3L18 11l-4.3 1.7L12 17l-1.7-4.3L6 11l4.3-1.7L12 5z" fill="white"/><path d="M18 15l.9 2.1L21 18l-2.1.9L18 21l-.9-2.1L15 18l2.1-.9L18 15z" fill="white" fill-opacity="0.85"/></svg>`,
        solarSpacer: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" fill="#0b0c10"/><circle cx="12" cy="12" r="3.5" fill="#ffaa00"/><circle cx="18" cy="8" r="1.5" fill="#4db2ff"/><path d="M5 16c3.5 3.5 10.5 3.5 14 0" stroke="#888" stroke-width="1.2" stroke-dasharray="2 2"/></svg>`,
        minesweeper: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="4" fill="#2d2d2d"/><rect x="4" y="4" width="16" height="16" rx="2" fill="#c0c0c0"/><path d="M4 20h16v-2H4v2z" fill="#808080"/><path d="M20 4v16h-2V4h2z" fill="#fff"/><circle cx="12" cy="12" r="4.5" fill="#1a1a1a"/><path d="M12 7v10M7 12h10M8.5 8.5l7 7M8.5 15.5l7-7" stroke="#e53935" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="12" r="1.5" fill="white"/></svg>`,
        riftboundRunner: `<svg viewBox="0 0 24 24" fill="none"><path d="M3 17.5 8 12l3.2 3.2L16 9l5 5" stroke="#8ff0ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 4h14v16H5z" stroke="#8ff0ff" stroke-width="1.5" opacity=".7"/><circle cx="16.8" cy="7.2" r="1.4" fill="#ffcf5a"/></svg>`,
        discord: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" fill="#5865F2"/><path d="M7 9.5c1.2-1 2.8-1.6 4.4-1.7l.4 1c-.6.1-1.2.3-1.8.6 2.5-.4 4.7.3 6 1.6.4 1.6.4 3.2 0 4.8-1.2 1.2-2.6 1.9-4.1 2.2l-.7-1.2c.6-.2 1.1-.5 1.6-.9-.2-.1-.5-.2-.7-.3-1.9.7-4 .7-5.9 0-.2.1-.5.2-.7.3.5.4 1 .7 1.6.9L6.4 18c-1.5-.3-2.9-1-4.1-2.2-.4-1.6-.4-3.2 0-4.8 1.1-1.2 2.9-1.9 4.7-1.5z" fill="white"/><circle cx="9.5" cy="12.5" r="1.1" fill="#5865F2"/><circle cx="14.5" cy="12.5" r="1.1" fill="#5865F2"/></svg>`
    };
