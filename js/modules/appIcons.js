const AppIcons = (() => {
    const icons = {
        ...
        minesweeper: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="4" fill="#333"/><circle cx="12" cy="12" r="5" fill="#e53935"/><path d="M12 4v3M12 17v3M4 12h3M17 12h3M6.3 6.3l2.1 2.1M15.6 15.6l2.1 2.1M6.3 17.7l2.1-2.1M15.6 8.4l2.1-2.1" stroke="white" stroke-width="1.8" stroke-linecap="round"/></svg>`
    };
